...
2. [Philippines COVID data](Session2#philippines-covid-data)
3. [Get the data](Session2#read-in-the-dataset)
4. [Calculate totals](Session2#calculate-times-series-of-cumulative-totals)
5. [Calculate lags](Session2#calculate-reporting-lags)
6. [Lag distributions](Session2#lag-distributions)
7. [Misc questions](Session2#questions-posed-in-class)
8. [Exercise](Session2#exercise)


[Session 3](Session3) (Wednesday, 11 Nov)

1. [Objective](Session3#objective)
2. [Get the data](Session3#read-in-the-ph-data)
3. [Merging](Session3#merging)
4. [Merge prep](Session3#Prepare-cases-and-deaths-to-merge)
5. [left joins](Session3#merging-cases-and-deaths-together)
6. [Misc questions](Session3#plot-cfr)
7. [add WPP data](Session3#merge-in-wpp-data)
8. [Exercise (several steps)](Session3#exercise)
9. [Mini lessons](Session3#mini-lessons)

[Session 4](Session4) (Thursday, 12 Nov)

1. [Objective](Session4#objective)
2. [Pivot concept](Session4#pivot-concept)
3. [Denmark COVID example](Session4#denmark-weekly-covid-data)
4. [WPP Example](Session4#wpp2019-data)
5. [Fertiltiy Example](Session4#Further-example-of-pivoting)
